 ...
 a. Insert Records into BookDetails Collection
	...
	> db.BookDetails.insertMany([ {no:1,title:"data structure",author:"Lipschute",subject:"DS",publisher:"McGraw",Quantity:4,price:217},
	{no:2,title:"DOS guide",author:"nortron",subject:"OS",publisher:"PHI",Quantity:3,price:175},
	{no:3,title:"Turbo c++",author:"Robert lafore",subject:"Prog",publisher:"Galgotia",Quantity:5,price:270},
	{no:4,title:"Dbase Dummies",author:"Palmer",subject:"DBMS",publisher:"PustakeM",Quantity:7,price:130},
 ...
 d. Find total quantity of books in the library.
	...
	> db.BookDetails.aggregate( {$match:{}},{ $group:{ _id:"Quantity",sum: { $sum:"$Quantity" } } } )
