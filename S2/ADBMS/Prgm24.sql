...
>  db.VehicleDetails.insertMany([{regno:"BRG446",make:"Ford",model:"Meteor",year:2009,color:"White"},{regno:"VRG655",make:"BMW",model:"Coupe",year:2008,color:"Blue"},{regno:"NMT667",make:"Madza",model:"Delivery Van",year:2010,color:"Green"},{regno:"CCT899",make:"Toyota",model:"HiLuke",year:2009,color:"Red"},{regno:"FGR122",make:"Mitsubishi",model:"Magna",year:2007,color:"purple"}])
